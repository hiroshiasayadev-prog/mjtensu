  ...
  cases: [
    ...
    },
    {
      ...
      expected: scored({
        ...
        dora: NO_DORA,
        han: 2,
        fu: standardFu(20, 10, 0, 0, 2, 2, 34, 40),
        limit: NO_LIMIT,
        winnerRole: 'non-dealer',
        winMethod: 'ron',
        payment: { kind: 'ron', amount: 2600 },
    ...
    },
    {
      ...
      expected: scored({
        ...
        dora: NO_DORA,
        han: 1,
        fu: standardFu(20, 0, 0, 0, 2, 2, 24, 30),
        limit: NO_LIMIT,
        winnerRole: 'non-dealer',
        winMethod: 'ron',
    ...
    {
      id: 'baiman-chinitsu',
      description: 'Eight-han closed tsumo exercises Baiman classification.',
      coverage: ['limit-baiman'],
      ruleProfileId: 'product-default',
      input: input(HAND_BAIMAN, 5, { winMethod: 'tsumo', riichi: 'riichi' }),
      expected: scored({
        yaku: [regular('riichi', 1), regular('menzen-tsumo', 1), regular('chinitsu', 6)],
        dora: NO_DORA,
        han: 8,
        fu: standardFu(20, 0, 2, 0, 0, 2, 24, 30),
        limit: { kind: 'baiman' },
